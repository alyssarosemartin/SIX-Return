...
library(curl)
rm(list=ls())
setwd("~/Documents/My Files/USA-NPN/Data/Analysis/R_default/SIXV/Tiffs")

#Download 2018 and 2019 NCEP rasters for SI-x Leaf Anomaly - need to insert updated URLs
curl_download("https://bit.ly/2MvnHOK", 'si-x_leaf_anomaly_ncep2018.tif', quiet = FALSE, mode = "wb")
curl_download("INSERT geoserver URL or bitly for today", 'si-x_leaf_anomaly_ncep2019.tif', quiet = FALSE, mode = "wb")  

#Use  a loop to get all the six anomalies across 1981-2017
